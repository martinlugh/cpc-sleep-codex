...
import com.cpc.sleepcodex.decision.rule.BaselineThresholdContextHolder;
...
public class RuleEngine {
    ...
    public RuleEngineResult evaluate(AlignedSegmentContext context) {
        return evaluate(context, BaselineThresholdContext.generic());
    }

    public RuleEngineResult evaluate(AlignedSegmentContext context, BaselineThresholdContext baselineThresholdContext) {
        ...
        BaselineThresholdContextHolder.set(baselineThresholdContext);
        try {
            ...
            BaselineThresholdContextHolder.clear();
        }
