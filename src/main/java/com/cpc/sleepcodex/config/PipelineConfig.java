...
public class PipelineConfig {
    ...
    @Bean
    public UserBaselineDataProvider userBaselineDataProvider() {
        return new NoopUserBaselineDataProvider();
    }

    @Bean
    public BaselineThresholdContextFactory baselineThresholdContextFactory() {
        return new BaselineThresholdContextFactory();
    }
}
